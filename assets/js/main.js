...
gsap.from('.home__img-3', 1, {opacity: 0, x: -100, rotation: -20, delay: 3, ease: "bounce.out(1.2)"})
gsap.from('.home__img-2', 1, {opacity: 0, x: -100, rotation: -20, delay: 3.5, ease: "bounce.out(1.2)"})
gsap.from('.home__img-1', 1, {opacity: 0, x: -100, rotation: -20, delay: 4, ease: "bounce.out(1.2)"})
gsap.from('.home__img-6', 1, {opacity: 0, x: 100, rotation: 20, delay: 3.5, ease: "bounce.out(1.2)"})
gsap.from('.home__img-9', 1, {opacity: 0, x: 100, rotation: 20, delay: 4, ease: "bounce.out(1.2)"})
